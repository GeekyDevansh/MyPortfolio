...
<motion.h1 initial={{opacity:0,scale:0}} whileInView={{opacity:1,scale:1}} transition={{duration:1}} className={`font-semibold ${darkMode?'text-white':'text-gray-900'} text-6xl text-center md:mb-10 mb-5`} >About Me</motion.h1>
...
<div className='flex justify-between' >
    ...
    <a href="https://drive.google.com/file/d/1nNXNn63rUfBixWax--gNQgKS9OAGGuEL/view" target='_blank'  className="font-semibold text-xl text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-pink-500 cursor-[url('/pointer.png'),_pointer]" >View My Resume.</a>
    </motion.div>
