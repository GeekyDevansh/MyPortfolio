...
<div className='flex justify-between' >
    ...
    <a href="https://drive.google.com/file/d/129lT8-VKSqO0RbOK5ZLE_CxtV3gpzWUS/view?usp=share_link" target='_blank' rel="noreferrer"  className="font-semibold text-xl text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-pink-500 cursor-[url('/pointer.png'),_pointer]" >View My Resume.</a>
    </motion.div>
